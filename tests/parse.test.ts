...
describe('parseSocialSecurityNumberDK', () => {
  ...
  it('throws on invalid birthdate - day', () => {
    expect(() => util.parseSocialSecurityNumberDK('001209-1235')).toThrowError('Invalid day of the month: 0.');
    expect(() => util.parseSocialSecurityNumberDK('321209-1235')).toThrowError('Invalid day of the month: 32.');
  });
  it('throws on invalid birthdate - month', () => {
    expect(() => util.parseSocialSecurityNumberDK('010009-1235')).toThrowError('Invalid month: 0.');
    expect(() => util.parseSocialSecurityNumberDK('011332-1235')).toThrowError('Invalid month: 13.');
  });
});
