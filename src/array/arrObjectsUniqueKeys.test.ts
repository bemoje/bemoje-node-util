...
describe('arrObjectsUniqueKeys', () => {
  ...
  it('should return an array of unique keys from the objects', () => {
    const result = arrObjectsUniqueKeys([{ key1: 'value1', key2: 'value2' }, { key2: 'value3', key3: 'value4' }, { key4: 'value5' }])
  ...
  it('should return an array of unique keys even if some objects have the same keys', () => {
    const result = arrObjectsUniqueKeys([{ key1: 'value1', key2: 'value2' }, { key2: 'value3', key3: 'value4' }, { key1: 'value5' }])
