import { tsDocStripAllTagsButThrowsParamDescription } from './tsDocStripAllTagsButThrowsParamDescription'

describe(tsDocStripAllTagsButThrowsParamDescription.name, () => {
