...
describe(AbstractFsPath.name, () => {
  ...
  describe('relative', () => {
    it('should return the relative path', () => {
      const path = new ExtendsAbstractFsPath(__filename)
      expect(path.relative).toBe(npath.join('src', 'filesystem', 'path', 'core', 'AbstractFsPath.test.ts'))
    })
  })
  ...
  describe('parentPath', () => {
    it('should return the parent directory path', () => {
      const path = new ExtendsAbstractFsPath(__filename)
      expect(path.parentPath).toBe(npath.join(process.cwd(), 'src', 'filesystem', 'path', 'core'))
    })
  })
  ...
  describe('relativeToArray', () => {
    it('should return an array of relative path segments', () => {
      ...
      expect(segments).toEqual(['src', 'filesystem', 'path', 'core', 'AbstractFsPath.test.ts'])
    })
  })
