[@bemoje/node-util](/docs/md/index.md) / FilePath
...
- [constructor](/docs/md/classes/FilePath.md#constructor)

### Properties

- [length](/docs/md/classes/FilePath.md#length)

### Accessors

- [absolute](/docs/md/classes/FilePath.md#absolute)
- [base](/docs/md/classes/FilePath.md#base)
- [exists](/docs/md/classes/FilePath.md#exists)
- [extension](/docs/md/classes/FilePath.md#extension)
- [filename](/docs/md/classes/FilePath.md#filename)
- [filepath](/docs/md/classes/FilePath.md#filepath)
- [isBlockDevicePath](/docs/md/classes/FilePath.md#isblockdevicepath)
- [isCharacterDevicePath](/docs/md/classes/FilePath.md#ischaracterdevicepath)
- [isDirectoryPath](/docs/md/classes/FilePath.md#isdirectorypath)
- [isFIFOPath](/docs/md/classes/FilePath.md#isfifopath)
- [isFilePath](/docs/md/classes/FilePath.md#isfilepath)
- [isSocketPath](/docs/md/classes/FilePath.md#issocketpath)
- [isSymbolicLinkPath](/docs/md/classes/FilePath.md#issymboliclinkpath)
- [name](/docs/md/classes/FilePath.md#name)
- [parent](/docs/md/classes/FilePath.md#parent)
- [parentPath](/docs/md/classes/FilePath.md#parentpath)
- [relative](/docs/md/classes/FilePath.md#relative)
- [root](/docs/md/classes/FilePath.md#root)

### Methods

- [[iterator]](/docs/md/classes/FilePath.md#[iterator])
- [anchor](/docs/md/classes/FilePath.md#anchor)
- [at](/docs/md/classes/FilePath.md#at)
- [big](/docs/md/classes/FilePath.md#big)
- [blink](/docs/md/classes/FilePath.md#blink)
- [bold](/docs/md/classes/FilePath.md#bold)
- [charAt](/docs/md/classes/FilePath.md#charat)
- [charCodeAt](/docs/md/classes/FilePath.md#charcodeat)
- [codePointAt](/docs/md/classes/FilePath.md#codepointat)
- [concat](/docs/md/classes/FilePath.md#concat)
- [endsWith](/docs/md/classes/FilePath.md#endswith)
- [fixed](/docs/md/classes/FilePath.md#fixed)
- [fontcolor](/docs/md/classes/FilePath.md#fontcolor)
- [fontsize](/docs/md/classes/FilePath.md#fontsize)
- [includes](/docs/md/classes/FilePath.md#includes)
- [indexOf](/docs/md/classes/FilePath.md#indexof)
- [isBlockDevice](/docs/md/classes/FilePath.md#isblockdevice)
- [isCharacterDevice](/docs/md/classes/FilePath.md#ischaracterdevice)
- [isDirectory](/docs/md/classes/FilePath.md#isdirectory)
- [isFIFO](/docs/md/classes/FilePath.md#isfifo)
- [isFile](/docs/md/classes/FilePath.md#isfile)
- [isSocket](/docs/md/classes/FilePath.md#issocket)
- [isSymbolicLink](/docs/md/classes/FilePath.md#issymboliclink)
- [isValidWindowsPath](/docs/md/classes/FilePath.md#isvalidwindowspath)
- [italics](/docs/md/classes/FilePath.md#italics)
- [lastIndexOf](/docs/md/classes/FilePath.md#lastindexof)
- [link](/docs/md/classes/FilePath.md#link)
- [localeCompare](/docs/md/classes/FilePath.md#localecompare)
- [match](/docs/md/classes/FilePath.md#match)
- [matchAll](/docs/md/classes/FilePath.md#matchall)
- [normalize](/docs/md/classes/FilePath.md#normalize)
- [padEnd](/docs/md/classes/FilePath.md#padend)
- [padStart](/docs/md/classes/FilePath.md#padstart)
- [readFile](/docs/md/classes/FilePath.md#readfile)
- [readFileString](/docs/md/classes/FilePath.md#readfilestring)
- [readFileStringSync](/docs/md/classes/FilePath.md#readfilestringsync)
- [readFileSync](/docs/md/classes/FilePath.md#readfilesync)
- [relativeToArray](/docs/md/classes/FilePath.md#relativetoarray)
- [repeat](/docs/md/classes/FilePath.md#repeat)
- [replace](/docs/md/classes/FilePath.md#replace)
- [replaceAll](/docs/md/classes/FilePath.md#replaceall)
- [search](/docs/md/classes/FilePath.md#search)
- [slice](/docs/md/classes/FilePath.md#slice)
- [small](/docs/md/classes/FilePath.md#small)
- [split](/docs/md/classes/FilePath.md#split)
- [startsWith](/docs/md/classes/FilePath.md#startswith)
- [stat](/docs/md/classes/FilePath.md#stat)
- [statSync](/docs/md/classes/FilePath.md#statsync)
- [strike](/docs/md/classes/FilePath.md#strike)
- [sub](/docs/md/classes/FilePath.md#sub)
- [substr](/docs/md/classes/FilePath.md#substr)
- [substring](/docs/md/classes/FilePath.md#substring)
- [sup](/docs/md/classes/FilePath.md#sup)
- [toArray](/docs/md/classes/FilePath.md#toarray)
- [toLocaleLowerCase](/docs/md/classes/FilePath.md#tolocalelowercase)
- [toLocaleUpperCase](/docs/md/classes/FilePath.md#tolocaleuppercase)
- [toLowerCase](/docs/md/classes/FilePath.md#tolowercase)
- [toString](/docs/md/classes/FilePath.md#tostring)
- [toUpperCase](/docs/md/classes/FilePath.md#touppercase)
- [trim](/docs/md/classes/FilePath.md#trim)
- [trimEnd](/docs/md/classes/FilePath.md#trimend)
- [trimLeft](/docs/md/classes/FilePath.md#trimleft)
- [trimRight](/docs/md/classes/FilePath.md#trimright)
- [trimStart](/docs/md/classes/FilePath.md#trimstart)
- [valueOf](/docs/md/classes/FilePath.md#valueof)
- [writeFile](/docs/md/classes/FilePath.md#writefile)
- [writeFileSync](/docs/md/classes/FilePath.md#writefilesync)
- [fromCharCode](/docs/md/classes/FilePath.md#fromcharcode)
- [fromCodePoint](/docs/md/classes/FilePath.md#fromcodepoint)
- [raw](/docs/md/classes/FilePath.md#raw)
...
[src/filesystem/path/FilePath.ts:19](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L19)
...
[src/filesystem/path/FilePath.ts:55](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L55)
...
[src/filesystem/path/FilePath.ts:47](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L47)
...
[src/filesystem/path/FilePath.ts:40](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L40)
...
[src/filesystem/path/FilePath.ts:26](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L26)
...
• `get` **parent**(): [`DirectoryPath`](/docs/md/classes/DirectoryPath.md)
...
[src/filesystem/path/FilePath.ts:33](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L33)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `encoding?` | [`NodeJsBufferEncoding`](/docs/md/index.md#nodejsbufferencoding) | The encoding to use. If none is specified, a Buffer is returned. |
...
[src/filesystem/path/FilePath.ts:71](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L71)
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `encoding` | [`NodeJsBufferEncoding`](/docs/md/index.md#nodejsbufferencoding) | `'utf8'` | The encoding to use. Defaults to 'utf8'. |
...
[src/filesystem/path/FilePath.ts:87](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L87)
...
[src/filesystem/path/FilePath.ts:79](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L79)
...
[src/filesystem/path/FilePath.ts:63](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L63)
...
[src/filesystem/path/FilePath.ts:108](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L108)
...
[src/filesystem/path/FilePath.ts:97](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/FilePath.ts#L97)
