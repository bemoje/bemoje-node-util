[@bemoje/node-util](/docs/md/index.md) / DirectoryPath
...
- [constructor](/docs/md/classes/DirectoryPath.md#constructor)

### Properties

- [length](/docs/md/classes/DirectoryPath.md#length)

### Accessors

- [absolute](/docs/md/classes/DirectoryPath.md#absolute)
- [base](/docs/md/classes/DirectoryPath.md#base)
- [dirpath](/docs/md/classes/DirectoryPath.md#dirpath)
- [exists](/docs/md/classes/DirectoryPath.md#exists)
- [isBlockDevicePath](/docs/md/classes/DirectoryPath.md#isblockdevicepath)
- [isCharacterDevicePath](/docs/md/classes/DirectoryPath.md#ischaracterdevicepath)
- [isDirectoryPath](/docs/md/classes/DirectoryPath.md#isdirectorypath)
- [isFIFOPath](/docs/md/classes/DirectoryPath.md#isfifopath)
- [isFilePath](/docs/md/classes/DirectoryPath.md#isfilepath)
- [isSocketPath](/docs/md/classes/DirectoryPath.md#issocketpath)
- [isSymbolicLinkPath](/docs/md/classes/DirectoryPath.md#issymboliclinkpath)
- [name](/docs/md/classes/DirectoryPath.md#name)
- [parent](/docs/md/classes/DirectoryPath.md#parent)
- [parentPath](/docs/md/classes/DirectoryPath.md#parentpath)
- [relative](/docs/md/classes/DirectoryPath.md#relative)
- [root](/docs/md/classes/DirectoryPath.md#root)

### Methods

- [[iterator]](/docs/md/classes/DirectoryPath.md#[iterator])
- [anchor](/docs/md/classes/DirectoryPath.md#anchor)
- [at](/docs/md/classes/DirectoryPath.md#at)
- [big](/docs/md/classes/DirectoryPath.md#big)
- [blink](/docs/md/classes/DirectoryPath.md#blink)
- [bold](/docs/md/classes/DirectoryPath.md#bold)
- [charAt](/docs/md/classes/DirectoryPath.md#charat)
- [charCodeAt](/docs/md/classes/DirectoryPath.md#charcodeat)
- [codePointAt](/docs/md/classes/DirectoryPath.md#codepointat)
- [concat](/docs/md/classes/DirectoryPath.md#concat)
- [endsWith](/docs/md/classes/DirectoryPath.md#endswith)
- [file](/docs/md/classes/DirectoryPath.md#file)
- [fixed](/docs/md/classes/DirectoryPath.md#fixed)
- [fontcolor](/docs/md/classes/DirectoryPath.md#fontcolor)
- [fontsize](/docs/md/classes/DirectoryPath.md#fontsize)
- [includes](/docs/md/classes/DirectoryPath.md#includes)
- [indexOf](/docs/md/classes/DirectoryPath.md#indexof)
- [isBlockDevice](/docs/md/classes/DirectoryPath.md#isblockdevice)
- [isCharacterDevice](/docs/md/classes/DirectoryPath.md#ischaracterdevice)
- [isDirectory](/docs/md/classes/DirectoryPath.md#isdirectory)
- [isFIFO](/docs/md/classes/DirectoryPath.md#isfifo)
- [isFile](/docs/md/classes/DirectoryPath.md#isfile)
- [isSocket](/docs/md/classes/DirectoryPath.md#issocket)
- [isSymbolicLink](/docs/md/classes/DirectoryPath.md#issymboliclink)
- [isValidWindowsPath](/docs/md/classes/DirectoryPath.md#isvalidwindowspath)
- [italics](/docs/md/classes/DirectoryPath.md#italics)
- [lastIndexOf](/docs/md/classes/DirectoryPath.md#lastindexof)
- [link](/docs/md/classes/DirectoryPath.md#link)
- [localeCompare](/docs/md/classes/DirectoryPath.md#localecompare)
- [match](/docs/md/classes/DirectoryPath.md#match)
- [matchAll](/docs/md/classes/DirectoryPath.md#matchall)
- [normalize](/docs/md/classes/DirectoryPath.md#normalize)
- [padEnd](/docs/md/classes/DirectoryPath.md#padend)
- [padStart](/docs/md/classes/DirectoryPath.md#padstart)
- [readdir](/docs/md/classes/DirectoryPath.md#readdir)
- [readdirSync](/docs/md/classes/DirectoryPath.md#readdirsync)
- [relativeToArray](/docs/md/classes/DirectoryPath.md#relativetoarray)
- [repeat](/docs/md/classes/DirectoryPath.md#repeat)
- [replace](/docs/md/classes/DirectoryPath.md#replace)
- [replaceAll](/docs/md/classes/DirectoryPath.md#replaceall)
- [search](/docs/md/classes/DirectoryPath.md#search)
- [slice](/docs/md/classes/DirectoryPath.md#slice)
- [small](/docs/md/classes/DirectoryPath.md#small)
- [split](/docs/md/classes/DirectoryPath.md#split)
- [startsWith](/docs/md/classes/DirectoryPath.md#startswith)
- [stat](/docs/md/classes/DirectoryPath.md#stat)
- [statSync](/docs/md/classes/DirectoryPath.md#statsync)
- [strike](/docs/md/classes/DirectoryPath.md#strike)
- [sub](/docs/md/classes/DirectoryPath.md#sub)
- [subdir](/docs/md/classes/DirectoryPath.md#subdir)
- [substr](/docs/md/classes/DirectoryPath.md#substr)
- [substring](/docs/md/classes/DirectoryPath.md#substring)
- [sup](/docs/md/classes/DirectoryPath.md#sup)
- [toArray](/docs/md/classes/DirectoryPath.md#toarray)
- [toLocaleLowerCase](/docs/md/classes/DirectoryPath.md#tolocalelowercase)
- [toLocaleUpperCase](/docs/md/classes/DirectoryPath.md#tolocaleuppercase)
- [toLowerCase](/docs/md/classes/DirectoryPath.md#tolowercase)
- [toString](/docs/md/classes/DirectoryPath.md#tostring)
- [toUpperCase](/docs/md/classes/DirectoryPath.md#touppercase)
- [trim](/docs/md/classes/DirectoryPath.md#trim)
- [trimEnd](/docs/md/classes/DirectoryPath.md#trimend)
- [trimLeft](/docs/md/classes/DirectoryPath.md#trimleft)
- [trimRight](/docs/md/classes/DirectoryPath.md#trimright)
- [trimStart](/docs/md/classes/DirectoryPath.md#trimstart)
- [valueOf](/docs/md/classes/DirectoryPath.md#valueof)
- [fromCharCode](/docs/md/classes/DirectoryPath.md#fromcharcode)
- [fromCodePoint](/docs/md/classes/DirectoryPath.md#fromcodepoint)
- [raw](/docs/md/classes/DirectoryPath.md#raw)
...
[src/filesystem/path/DirectoryPath.ts:17](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L17)
...
[src/filesystem/path/DirectoryPath.ts:24](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L24)
...
[src/filesystem/path/DirectoryPath.ts:31](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L31)
...
[src/filesystem/path/DirectoryPath.ts:38](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L38)
...
▸ **file**(`filename`): [`FilePath`](/docs/md/classes/FilePath.md)
...
[src/filesystem/path/DirectoryPath.ts:54](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L54)
...
▸ **readdir**(): `Promise`<[`AbstractFsPath`](/docs/md/classes/AbstractFsPath.md)[]\>
...
`Promise`<[`AbstractFsPath`](/docs/md/classes/AbstractFsPath.md)[]\>

#### Defined in

[src/filesystem/path/DirectoryPath.ts:74](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L74)

___

### readdirSync

▸ **readdirSync**(): [`AbstractFsPath`](/docs/md/classes/AbstractFsPath.md)[]
...
[src/filesystem/path/DirectoryPath.ts:62](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L62)
...
▸ **subdir**(`...paths`): [`DirectoryPath`](/docs/md/classes/DirectoryPath.md)
...
[src/filesystem/path/DirectoryPath.ts:46](https://github.com/bemoje/bemoje-node-util/blob/b545282/src/filesystem/path/DirectoryPath.ts#L46)
