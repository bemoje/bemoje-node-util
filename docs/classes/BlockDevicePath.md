[@bemoje/node-util](/docs/index.md) / BlockDevicePath
...
- [constructor](/docs/classes/BlockDevicePath.md#constructor)

### Properties

- [length](/docs/classes/BlockDevicePath.md#length)

### Accessors

- [absolute](/docs/classes/BlockDevicePath.md#absolute)
- [base](/docs/classes/BlockDevicePath.md#base)
- [exists](/docs/classes/BlockDevicePath.md#exists)
- [isBlockDevicePath](/docs/classes/BlockDevicePath.md#isblockdevicepath)
- [isCharacterDevicePath](/docs/classes/BlockDevicePath.md#ischaracterdevicepath)
- [isDirectoryPath](/docs/classes/BlockDevicePath.md#isdirectorypath)
- [isFIFOPath](/docs/classes/BlockDevicePath.md#isfifopath)
- [isFilePath](/docs/classes/BlockDevicePath.md#isfilepath)
- [isSocketPath](/docs/classes/BlockDevicePath.md#issocketpath)
- [isSymbolicLinkPath](/docs/classes/BlockDevicePath.md#issymboliclinkpath)
- [name](/docs/classes/BlockDevicePath.md#name)
- [parentPath](/docs/classes/BlockDevicePath.md#parentpath)
- [relative](/docs/classes/BlockDevicePath.md#relative)
- [root](/docs/classes/BlockDevicePath.md#root)

### Methods

- [[iterator]](/docs/classes/BlockDevicePath.md#[iterator])
- [anchor](/docs/classes/BlockDevicePath.md#anchor)
- [at](/docs/classes/BlockDevicePath.md#at)
- [big](/docs/classes/BlockDevicePath.md#big)
- [blink](/docs/classes/BlockDevicePath.md#blink)
- [bold](/docs/classes/BlockDevicePath.md#bold)
- [charAt](/docs/classes/BlockDevicePath.md#charat)
- [charCodeAt](/docs/classes/BlockDevicePath.md#charcodeat)
- [codePointAt](/docs/classes/BlockDevicePath.md#codepointat)
- [concat](/docs/classes/BlockDevicePath.md#concat)
- [endsWith](/docs/classes/BlockDevicePath.md#endswith)
- [fixed](/docs/classes/BlockDevicePath.md#fixed)
- [fontcolor](/docs/classes/BlockDevicePath.md#fontcolor)
- [fontsize](/docs/classes/BlockDevicePath.md#fontsize)
- [includes](/docs/classes/BlockDevicePath.md#includes)
- [indexOf](/docs/classes/BlockDevicePath.md#indexof)
- [isBlockDevice](/docs/classes/BlockDevicePath.md#isblockdevice)
- [isCharacterDevice](/docs/classes/BlockDevicePath.md#ischaracterdevice)
- [isDirectory](/docs/classes/BlockDevicePath.md#isdirectory)
- [isFIFO](/docs/classes/BlockDevicePath.md#isfifo)
- [isFile](/docs/classes/BlockDevicePath.md#isfile)
- [isSocket](/docs/classes/BlockDevicePath.md#issocket)
- [isSymbolicLink](/docs/classes/BlockDevicePath.md#issymboliclink)
- [isValidWindowsPath](/docs/classes/BlockDevicePath.md#isvalidwindowspath)
- [italics](/docs/classes/BlockDevicePath.md#italics)
- [lastIndexOf](/docs/classes/BlockDevicePath.md#lastindexof)
- [link](/docs/classes/BlockDevicePath.md#link)
- [localeCompare](/docs/classes/BlockDevicePath.md#localecompare)
- [match](/docs/classes/BlockDevicePath.md#match)
- [matchAll](/docs/classes/BlockDevicePath.md#matchall)
- [normalize](/docs/classes/BlockDevicePath.md#normalize)
- [padEnd](/docs/classes/BlockDevicePath.md#padend)
- [padStart](/docs/classes/BlockDevicePath.md#padstart)
- [relativeToArray](/docs/classes/BlockDevicePath.md#relativetoarray)
- [repeat](/docs/classes/BlockDevicePath.md#repeat)
- [replace](/docs/classes/BlockDevicePath.md#replace)
- [replaceAll](/docs/classes/BlockDevicePath.md#replaceall)
- [search](/docs/classes/BlockDevicePath.md#search)
- [slice](/docs/classes/BlockDevicePath.md#slice)
- [small](/docs/classes/BlockDevicePath.md#small)
- [split](/docs/classes/BlockDevicePath.md#split)
- [startsWith](/docs/classes/BlockDevicePath.md#startswith)
- [stat](/docs/classes/BlockDevicePath.md#stat)
- [statSync](/docs/classes/BlockDevicePath.md#statsync)
- [strike](/docs/classes/BlockDevicePath.md#strike)
- [sub](/docs/classes/BlockDevicePath.md#sub)
- [substr](/docs/classes/BlockDevicePath.md#substr)
- [substring](/docs/classes/BlockDevicePath.md#substring)
- [sup](/docs/classes/BlockDevicePath.md#sup)
- [toArray](/docs/classes/BlockDevicePath.md#toarray)
- [toLocaleLowerCase](/docs/classes/BlockDevicePath.md#tolocalelowercase)
- [toLocaleUpperCase](/docs/classes/BlockDevicePath.md#tolocaleuppercase)
- [toLowerCase](/docs/classes/BlockDevicePath.md#tolowercase)
- [toString](/docs/classes/BlockDevicePath.md#tostring)
- [toUpperCase](/docs/classes/BlockDevicePath.md#touppercase)
- [trim](/docs/classes/BlockDevicePath.md#trim)
- [trimEnd](/docs/classes/BlockDevicePath.md#trimend)
- [trimLeft](/docs/classes/BlockDevicePath.md#trimleft)
- [trimRight](/docs/classes/BlockDevicePath.md#trimright)
- [trimStart](/docs/classes/BlockDevicePath.md#trimstart)
- [valueOf](/docs/classes/BlockDevicePath.md#valueof)
- [fromCharCode](/docs/classes/BlockDevicePath.md#fromcharcode)
- [fromCodePoint](/docs/classes/BlockDevicePath.md#fromcodepoint)
- [raw](/docs/classes/BlockDevicePath.md#raw)
...
src/filesystem/path/core/BlockDevicePath.ts:16
...
src/filesystem/path/core/BlockDevicePath.ts:23
