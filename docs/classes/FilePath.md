[@bemoje/node-util](/docs/index.md) / FilePath
...
- [constructor](/docs/classes/FilePath.md#constructor)

### Properties

- [length](/docs/classes/FilePath.md#length)

### Accessors

- [absolute](/docs/classes/FilePath.md#absolute)
- [base](/docs/classes/FilePath.md#base)
- [exists](/docs/classes/FilePath.md#exists)
- [extension](/docs/classes/FilePath.md#extension)
- [filename](/docs/classes/FilePath.md#filename)
- [filepath](/docs/classes/FilePath.md#filepath)
- [isBlockDevicePath](/docs/classes/FilePath.md#isblockdevicepath)
- [isCharacterDevicePath](/docs/classes/FilePath.md#ischaracterdevicepath)
- [isDirectoryPath](/docs/classes/FilePath.md#isdirectorypath)
- [isFIFOPath](/docs/classes/FilePath.md#isfifopath)
- [isFilePath](/docs/classes/FilePath.md#isfilepath)
- [isSocketPath](/docs/classes/FilePath.md#issocketpath)
- [isSymbolicLinkPath](/docs/classes/FilePath.md#issymboliclinkpath)
- [name](/docs/classes/FilePath.md#name)
- [parent](/docs/classes/FilePath.md#parent)
- [parentPath](/docs/classes/FilePath.md#parentpath)
- [relative](/docs/classes/FilePath.md#relative)
- [root](/docs/classes/FilePath.md#root)

### Methods

- [[iterator]](/docs/classes/FilePath.md#[iterator])
- [anchor](/docs/classes/FilePath.md#anchor)
- [at](/docs/classes/FilePath.md#at)
- [big](/docs/classes/FilePath.md#big)
- [blink](/docs/classes/FilePath.md#blink)
- [bold](/docs/classes/FilePath.md#bold)
- [charAt](/docs/classes/FilePath.md#charat)
- [charCodeAt](/docs/classes/FilePath.md#charcodeat)
- [codePointAt](/docs/classes/FilePath.md#codepointat)
- [concat](/docs/classes/FilePath.md#concat)
- [endsWith](/docs/classes/FilePath.md#endswith)
- [fixed](/docs/classes/FilePath.md#fixed)
- [fontcolor](/docs/classes/FilePath.md#fontcolor)
- [fontsize](/docs/classes/FilePath.md#fontsize)
- [includes](/docs/classes/FilePath.md#includes)
- [indexOf](/docs/classes/FilePath.md#indexof)
- [isBlockDevice](/docs/classes/FilePath.md#isblockdevice)
- [isCharacterDevice](/docs/classes/FilePath.md#ischaracterdevice)
- [isDirectory](/docs/classes/FilePath.md#isdirectory)
- [isFIFO](/docs/classes/FilePath.md#isfifo)
- [isFile](/docs/classes/FilePath.md#isfile)
- [isSocket](/docs/classes/FilePath.md#issocket)
- [isSymbolicLink](/docs/classes/FilePath.md#issymboliclink)
- [isValidWindowsPath](/docs/classes/FilePath.md#isvalidwindowspath)
- [italics](/docs/classes/FilePath.md#italics)
- [lastIndexOf](/docs/classes/FilePath.md#lastindexof)
- [link](/docs/classes/FilePath.md#link)
- [localeCompare](/docs/classes/FilePath.md#localecompare)
- [match](/docs/classes/FilePath.md#match)
- [matchAll](/docs/classes/FilePath.md#matchall)
- [normalize](/docs/classes/FilePath.md#normalize)
- [padEnd](/docs/classes/FilePath.md#padend)
- [padStart](/docs/classes/FilePath.md#padstart)
- [readFile](/docs/classes/FilePath.md#readfile)
- [readFileString](/docs/classes/FilePath.md#readfilestring)
- [readFileStringSync](/docs/classes/FilePath.md#readfilestringsync)
- [readFileSync](/docs/classes/FilePath.md#readfilesync)
- [relativeToArray](/docs/classes/FilePath.md#relativetoarray)
- [repeat](/docs/classes/FilePath.md#repeat)
- [replace](/docs/classes/FilePath.md#replace)
- [replaceAll](/docs/classes/FilePath.md#replaceall)
- [search](/docs/classes/FilePath.md#search)
- [slice](/docs/classes/FilePath.md#slice)
- [small](/docs/classes/FilePath.md#small)
- [split](/docs/classes/FilePath.md#split)
- [startsWith](/docs/classes/FilePath.md#startswith)
- [stat](/docs/classes/FilePath.md#stat)
- [statSync](/docs/classes/FilePath.md#statsync)
- [strike](/docs/classes/FilePath.md#strike)
- [sub](/docs/classes/FilePath.md#sub)
- [substr](/docs/classes/FilePath.md#substr)
- [substring](/docs/classes/FilePath.md#substring)
- [sup](/docs/classes/FilePath.md#sup)
- [toArray](/docs/classes/FilePath.md#toarray)
- [toLocaleLowerCase](/docs/classes/FilePath.md#tolocalelowercase)
- [toLocaleUpperCase](/docs/classes/FilePath.md#tolocaleuppercase)
- [toLowerCase](/docs/classes/FilePath.md#tolowercase)
- [toString](/docs/classes/FilePath.md#tostring)
- [toUpperCase](/docs/classes/FilePath.md#touppercase)
- [trim](/docs/classes/FilePath.md#trim)
- [trimEnd](/docs/classes/FilePath.md#trimend)
- [trimLeft](/docs/classes/FilePath.md#trimleft)
- [trimRight](/docs/classes/FilePath.md#trimright)
- [trimStart](/docs/classes/FilePath.md#trimstart)
- [valueOf](/docs/classes/FilePath.md#valueof)
- [writeFile](/docs/classes/FilePath.md#writefile)
- [writeFileSync](/docs/classes/FilePath.md#writefilesync)
- [fromCharCode](/docs/classes/FilePath.md#fromcharcode)
- [fromCodePoint](/docs/classes/FilePath.md#fromcodepoint)
- [raw](/docs/classes/FilePath.md#raw)
...
src/filesystem/path/FilePath.ts:19
...
src/filesystem/path/FilePath.ts:55
...
src/filesystem/path/FilePath.ts:47
...
src/filesystem/path/FilePath.ts:40
...
src/filesystem/path/FilePath.ts:26
...
src/filesystem/path/FilePath.ts:33
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `encoding?` | [`NodeJsBufferEncoding`](/docs/index.md#nodejsbufferencoding) | The encoding to use. If none is specified, a Buffer is returned. |
...
src/filesystem/path/FilePath.ts:71
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `encoding` | [`NodeJsBufferEncoding`](/docs/index.md#nodejsbufferencoding) | `'utf8'` | The encoding to use. Defaults to 'utf8'. |
...
src/filesystem/path/FilePath.ts:87
...
src/filesystem/path/FilePath.ts:79
...
src/filesystem/path/FilePath.ts:63
...
src/filesystem/path/FilePath.ts:108
...
src/filesystem/path/FilePath.ts:97
