 ...
 * ```
 */
export declare function readExcelFileWorksheet(filepath: string, worksheetIndexOrName?: string | number): Promise<string[][]>;
//# sourceMappingURL=readExcelFileWorksheet.d.ts.map