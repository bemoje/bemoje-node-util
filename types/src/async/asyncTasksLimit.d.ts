 ...
 * ```
 */
export declare function asyncTasksLimit<T>(concurrency: number, tasks: Array<() => Promise<any>>, callback?: (value: T, index: number) => void): Promise<T[]>;
//# sourceMappingURL=asyncTasksLimit.d.ts.map