 ...
 * ```
 */
export declare function objPropertyValueToGetter<V, T extends Record<ObjectKey, V>>(object: T, ...propertyNames: ObjectKey[]): T;
//# sourceMappingURL=objPropertyValueToGetter.d.ts.map