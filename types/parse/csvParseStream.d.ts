 ...
 * ```
 */
export declare function csvParseStream(stream: Readable, options: CsvParserOptions): Promise<Array<Record<string, string>>>;
//# sourceMappingURL=csvParseStream.d.ts.map