 ...
 */
function numIsBetween(number, lower, upper) {
 ...
 */
function numIsBetweenExclusive(number, lower, upper) {
    return number > lower && number < upper;
}
...
function oKeysArray(o) {
    return Array.from(Object.keys(o));
}

function oValuesArray(o) {
    return Array.from(Object.values(o));
}

function oEntriesArray(o) {
...
exports.HTML_EVENT_ATTRIBUTES = HTML_EVENT_ATTRIBUTES;
exports.HTML_GLOBAL_ATTRIBUTES = HTML_GLOBAL_ATTRIBUTES;
...
exports.numIsBetween = numIsBetween;
exports.numIsBetweenExclusive = numIsBetweenExclusive;
