 ...
 */
export declare class CharacterDevicePath extends AbstractFsPath {
    /**
     ...
     */
    constructor(absolute: string, _unsafe?: boolean);
    /**
     * Returns whether this is an CharacterDevicePath instance.
     */
    get isCharacterDevicePath(): boolean;
}
//# sourceMappingURL=CharacterDevicePath.d.ts.map