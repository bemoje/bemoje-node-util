 ...
 * ```
 */
export declare function objUpdate<V>(obj: Record<ObjectKey, V>, key: ObjectKey, callback: (value: V | undefined, key: ObjectKey) => V): V;
//# sourceMappingURL=objUpdate.d.ts.map