...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('timsort'), require('sentence-splitter'), require('lodash'), require('date-and-time'), require('path'), require('format-number'), require('fs'), require('stream')) :
  typeof define === 'function' && define.amd ? define(['exports', 'timsort', 'sentence-splitter', 'lodash', 'date-and-time', 'path', 'format-number', 'fs', 'stream'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.util = {}, global.timsort, global.sentenceSplitter, global.lodash, global.date, global.Path, global.numberFormat, global.fs, global.stream));
})(this, (function (exports, timsort, sentenceSplitter, lodash, date, Path, numberFormat, fs, stream) { 'use strict';
